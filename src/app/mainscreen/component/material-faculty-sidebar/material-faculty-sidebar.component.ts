...
@Component({
  selector: 'app-material-faculty-sidebar',
  templateUrl: './material-faculty-sidebar.component.html',
  styleUrls: ['./material-faculty-sidebar.component.scss']
})
export class MaterialFacultySidebarComponent implements OnInit {
  ...
  ngOnInit() {
    this.route.queryParams.subscribe(params => {
      ...
      let facultyId: number = parseInt(params["facultyId"]);
      let subCourseId: number = parseInt(params["subCourseId"]);
      this.courseService.getTopicListByFacultyId(facultyId, subCourseId).subscribe((topicList) => {
